        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (canContinue()) {
                    ...
                    if (!isAddressValid()) {
                        makeSnackbar(R.string.fragment_profile_shipping_address_valid_address);
                    } else if (!isAddress2Valid()) {
                        makeSnackbar(R.string.fragment_profile_shipping_address_valid_address_two);
                    } else if (!isCityValid()) {
                        makeSnackbar(R.string.fragment_profile_shipping_address_valid_city);
                    } else if (!isStateValid()) {
                        makeSnackbar(R.string.fragment_profile_shipping_address_valid_state);
                    } else {
                        makeSnackbar(R.string.fragment_profile_shipping_address_valid_zip);
                    }
                }
            }
        });
    ...
    public void updateAddress(String etAddress, String etAddress2, String etCity, String etState, String etZip) {
        ...
        RestClient.getAuthenticated().updateAddress(userId, request).enqueue( new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                ...
                final Snackbar snackbar = Snackbar.make(relativeLayout, R.string.fragment_profile_shipping_address_updated, Snackbar.LENGTH_LONG);
                snackbar.show();
            }
