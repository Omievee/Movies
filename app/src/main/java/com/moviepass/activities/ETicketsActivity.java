...
public class ETicketsActivity extends BaseActivity {
        ...
        bottomNavigationView.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (itemId == R.id.action_profile) {
                    ...
                    Toast.makeText(ETicketsActivity.this, "Notification Activity", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(getApplicationContext(), NotificationsActivity.class));
                } else if (itemId == R.id.action_settings) {
                    Toast.makeText(ETicketsActivity.this, "Settings Activity", Toast.LENGTH_LONG).show();
