...
public final class RxJava2CallAdapterFactory extends CallAdapter.Factory {
  ...
  public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
    ...
    if (rawType == Completable.class) {
      ...
      return new RxJava2CallAdapter(gson, Void.class, scheduler, isAsync, false, true, false, false,
          false, true);
    }
    ...
    return new RxJava2CallAdapter(gson, responseType, scheduler, isAsync, isResult, isBody, isFlowable,
