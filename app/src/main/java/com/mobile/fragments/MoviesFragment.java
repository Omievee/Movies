...
//        RestClient.getLocalStorageAPI().getAllCurrentMovies().enqueue(new Callback<CurrentMoviesResponse>() {
//            @Override
//            public void onResponse(Call<CurrentMoviesResponse> call, Response<CurrentMoviesResponse> response) {
//                CurrentMoviesResponse localStorageMovies = response.body();
...
//
//            @Override
//            public void onFailure(Call<CurrentMoviesResponse> call, Throwable t) {
