...
//                }
//            } else {
//                Toast.makeText(myContext, "Incorrect Pattern", Toast.LENGTH_SHORT).show();
...
////        Location mCurrentLocation = UserLocationManagerFused.getLocationInstance(myContext).mCurrentLocation;
////        UserLocationManagerFused.getLocationInstance(myContext).updateLocation(mCurrentLocation);
////
...
////        Intent confirmationIntent = new Intent(myContext, ConfirmationActivity.class);
